//
//  UIImage+JXImageEffects.m
//  JXExtension
//
//  Created by JeasonLee on 2020/4/30.
//  Copyright © 2020 Jeason.Lee. All rights reserved.
//
//  https://developer.apple.com/library/content/samplecode/UIImageEffects/Introduction/Intro.html
//
...
@implementation UIImage (JXImageEffects)
...
+ (UIImage *)jx_imageByApplyingLightEffectToImage:(UIImage *)inputImage {
    ...
    return [self jx_imageByApplyingBlurToImage:inputImage withRadius:60 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
+ (UIImage *)jx_imageByApplyingExtraLightEffectToImage:(UIImage *)inputImage {
    ...
    return [self jx_imageByApplyingBlurToImage:inputImage withRadius:40 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
+ (UIImage *)jx_imageByApplyingTintEffectWithColor:(UIColor *)tintColor toImage:(UIImage *)inputImage {
    ...
    return [self jx_imageByApplyingBlurToImage:inputImage withRadius:20 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
